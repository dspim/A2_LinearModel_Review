...
## -2.842 -0.717 -0.016  0.680  3.635 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)    
## (Intercept)   0.7503     0.0763    9.83   <2e-16 ***
## X             1.6191     0.0331   48.91   <2e-16 ***
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 1.03 on 998 degrees of freedom
## Multiple R-squared:  0.706,	Adjusted R-squared:  0.705 
## F-statistic: 2.39e+03 on 1 and 998 DF,  p-value: <2e-16
```
...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -15.191  -3.247   0.189   3.337  15.178 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)    
## (Intercept)    1.112      0.331    3.36  0.00081 ***
## X              1.378      0.148    9.28  < 2e-16 ***
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 4.84 on 998 degrees of freedom
## Multiple R-squared:  0.0795,	Adjusted R-squared:  0.0786 
## F-statistic: 86.2 on 1 and 998 DF,  p-value: <2e-16
```
